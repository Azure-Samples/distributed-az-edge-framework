...
# If you'd like to enforce permanent deletion of suspended app registrations  you can use the PowerSheel script below
...
# TODO add a comment on permanently delete
