...
$r = (az deployment sub create --location $Location `
           --template-file .\bicep\az-demo.bicep --parameters applicationName=$ApplicationName `
...
# ----- Copy and Push Containers to ACR (System Module)
...
# ----- Copy and Push Containers to ACR (OPC Publisher)
